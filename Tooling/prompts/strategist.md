...
- **`inject_batch_done`** — every Forward in a prior `Inject(chain_briefs=...)` batch has finished. Context.md `## Completed Inject batches` lists each brief + outcome. Decide the follow-up.
