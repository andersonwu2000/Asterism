...
Read `Context.md`: your assignment (the goal statement) and the argument given for it. Check that the argument settles this goal — that check is the whole turn.
