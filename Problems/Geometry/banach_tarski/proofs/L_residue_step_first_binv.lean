...
-- entry_kind: Builder
theorem residue_step_first_binv
    ...
    ∃ p' q' r' : ℤ,
      List.foldr step (0, 1, 0) ((1, false) :: M) = (p', q', r') ∧ ¬ (3 ∣ q') ∧
      ( (((1, false) :: M).head? = some (0, true)  ∧ p' ≡ q'  [ZMOD 3] ∧ r' ≡ 0 [ZMOD 3]) ∨
        (((1, false) :: M).head? = some (0, false) ∧ p' ≡ -q' [ZMOD 3] ∧ r' ≡ 0 [ZMOD 3]) ∨
        (((1, false) :: M).head? = some (1, true)  ∧ q' ≡ -r' [ZMOD 3] ∧ p' ≡ 0 [ZMOD 3]) ∨
        (((1, false) :: M).head? = some (1, false) ∧ q' ≡ r'  [ZMOD 3] ∧ p' ≡ 0 [ZMOD 3]) ) := by
  sorry
