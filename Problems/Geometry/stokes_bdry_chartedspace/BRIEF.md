# Geometry.stokes_bdry_chartedspace — BRIEF
...
- **Geometry.stokes_bdry_compact** (2 decls)
- **Geometry.stokes_bdry_invfun_mem** (6 decls)
- **Geometry.stokes_bdry_chart** (15 decls)
- **Geometry.stokes_bdry_chart_topo** (11 decls)
- **Geometry.stokes_form_coord_comp** (2 decls)
- **Geometry.stokes_form_coord_cont** (1 decls)
- **Geometry.stokes_form_coord_self** (1 decls)
- **Geometry.stokes_bdry_chartedspace** (2 decls)
- **Geometry.stokes_form_bundle** (13 decls)
- **Geometry.stokes_mextderiv** (16 decls)
- **Geometry.stokes_dd_zero** (5 decls)
