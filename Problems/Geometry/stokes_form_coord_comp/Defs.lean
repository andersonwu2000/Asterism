/-
  Defs.lean — shared vocabulary for the `formCoordChange_comp` obligation
  (§A.3, the cocycle condition of the Stokes form-bundle construction). Just the
  genuine, sorry-free `formCoordChange` data def; the lemma to prove is the Root.
-/
import Mathlib
