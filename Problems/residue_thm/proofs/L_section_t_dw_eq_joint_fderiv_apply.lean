...
-- section_t_dw_eq_joint_fderiv_apply: t-section derivWithin equals joint fderivWithin at (0,1)
-- Chain rule via HasFDerivWithinAt.comp_hasDerivWithinAt with embedding t' ↦ (τ', t')
theorem section_t_dw_eq_joint_fderiv_apply
    ...
    have hHfd : HasFDerivWithinAt (fun q : ℝ × ℝ => H q.1 q.2)
      ...
      (hH.differentiableOn (by norm_num) (τ', t)
        (Set.mk_mem_prod hτ' ht)).hasFDerivWithinAt
