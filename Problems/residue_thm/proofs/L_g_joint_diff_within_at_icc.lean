...
-- g_joint_diff_within_at_icc: DifferentiableWithinAt for f(H p)·fderivWithin H (0,1) on Icc×Icc,
-- via ContDiffOn ℝ 1 of product (C¹ composition from AnalyticOn + C¹ fderivWithin from C² hH).
-- entry_kind: Builder

theorem g_joint_diff_within_at_icc
  ...
  intro τ hτ t ht
  have hmem : (τ, t) ∈ Set.Icc (0:ℝ) 1 ×ˢ Set.Icc (0:ℝ) 1 := ⟨hτ, ht⟩
