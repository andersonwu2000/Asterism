...
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_block_eq_zero
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_cb_coe_li
...
theorem s11005
    ...
    ∀ (c : Fin m), g ⟨Sum.inr c, (0 : Fin 1)⟩ = 0 := by sorry
