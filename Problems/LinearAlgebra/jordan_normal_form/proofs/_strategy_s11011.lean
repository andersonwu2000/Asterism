...
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_pushforward_linearity
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_reindex_pushforward_sum
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_succ_chain_pushforward
...
theorem s11011
    ...
    N (∑ i, g i • v i) =
      (∑ (ti : Σ t : {t : Fin p // 0 < l t}, Fin (l t.1)),
        g ⟨Sum.inl ti.1, ti.2.succ⟩ • (↑(d ⟨ti.1.1, ti.2⟩) : W)) := by sorry
