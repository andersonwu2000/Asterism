...
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_pushforward_inl_zero
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_pushforward_inr_zero
import Problems.LinearAlgebra.jordan_normal_form.proofs.L_sigma_sum_drop_zero_terms
...
theorem s11020
    ...
    (∑ i, g i • N (v i)) =
      (∑ (ti : Σ t : {t : Fin p // 0 < l t}, Fin (l t.1)),
        g ⟨Sum.inl ti.1, ti.2.succ⟩ • N (v ⟨Sum.inl ti.1, ti.2.succ⟩)) := by sorry
