...
import Problems.LinearAlgebra.invariant_factor_decomposition.proofs._strategy_s11573

namespace Problems.LinearAlgebra.invariant_factor_decomposition

def directsum_grid_crt := @Problems.LinearAlgebra.invariant_factor_decomposition.s11573
