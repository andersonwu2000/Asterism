...
_WATERMARKS = {
    ...
    "Tooling/pipeline/strategist/verify.py": 1150,  # +32 2026-09-02 HID D2: `INGEST_REPORT_REQUIRED` + the Ingest-report structural gate (written now, armed with the prompt)  # +9 2026-08-30 two-part brick shape gate on Inject proof  # +17 2026-08-30 refuted needs the gate-born brick; Ingest accepts a disproved root  # born 2026-08-28 from the strategist.py split (B1)  # +routine audit 2026-08-30; +7 2026-08-30 action gate reads target_id, shelved roots not in flight (3e61beb9 shipped red here — caught 05:59Z)
