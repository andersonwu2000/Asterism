...
_WATERMARKS = {
    ...
    "Tooling/agent/phase2_context/outcomes.py": 890,  # +44 2026-09-03 the third reading of an unfinished step: a group the OWNER opened runs, but not on the reader's line — `_bucket` / `_owner_opened_lines`, one classifier for the scoreboard and the companion  # born 2026-08-28 from the phase2_context.py split (B2)
