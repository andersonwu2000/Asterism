...
_WATERMARKS = {
    ...
    "Tooling/pipeline/theorist/review.py": 245,  # +15 2026-09-06 a refused theory document lands too (owner ruling): the reviewer's dynamic manifest says what `agent/` now holds, since the static prompt calls it the accepted ones
