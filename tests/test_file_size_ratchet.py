...
_WATERMARKS = {
    ...
    "Tooling/pipeline/strategist/model.py": 306,  # +6 2026-09-05 `PROMPT_ALIAS` / `prompt_kind` — the one resolution from trigger_kind to prompt file, now that pending_review.md has retired  # born 2026-08-28 from the strategist.py split (B1)
