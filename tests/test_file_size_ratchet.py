...
_WATERMARKS = {
    ...
    "Tooling/pipeline/theorist/landing.py": 225,  # +75 2026-09-06 a refused theory document lands too (owner ruling): the header opens with `status:` and carries the fired ruling, the filename carries `_rejected`, and `_free_name` stops a same-minute twin overwriting the record — conscious bump
