...
_WATERMARKS = {
    ...
    "Tooling/knowledge/workspace_query.py": 1540,  # +38 2026-09-05 a glob spec resolves its own prefix, so the workspace-root fallback and the .lake wall reach both spellings  # +12 2026-09-05 a grep hit is the file's own line (edit anchors) + a non-greedy resume-anchor parse  # +25 2026-08-31 decl problem scoping + .lake workspace anchor; the 08-29 split promise still stands  # +20 2026-08-31 decl problem scoping + .lake workspace anchor; the 08-29 split promise still stands  # 2026-08-29 outline roster + defer-by-name + decl gNNNN (+41); next growth = split, not a bump
