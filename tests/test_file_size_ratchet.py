...
_WATERMARKS = {
    ...
    "Tooling/core/dispatcher/triggers.py": 710,  # +20 2026-09-04 reconcile_stuck_states class 3: an unanswered `Theorize` has a WORKER and nothing else re-derives it  # +11 2026-09-04 a Theorist row addressed to a group that already left is spent, not delayed  # +36 2026-09-03 `strategist_has_nothing_to_deliver` — the residual-case read of the classifier that door uses  # 2026-08-31 bench seat guard  # +18 2026-08-31 active-group seat guard + moot-verdict extinguish  # +suppress_stall (promotion gate) 2026-08-30
