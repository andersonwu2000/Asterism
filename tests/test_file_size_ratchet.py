...
_WATERMARKS = {
    ...
    "Tooling/state/db/strategies.py": 425,  # +25 2026-09-06 `decision_infra_deaths` / `record_decision_infra_death` — the bound on re-queueing a request whose worker died on infra, charged in ONE place — conscious bump  # born 2026-08-29 from the db.py split
