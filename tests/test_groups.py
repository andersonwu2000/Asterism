...
def test_v35_migrates_a_v34_db_without_losing_rows(tmp_path):
    ...
    assert conn.execute("PRAGMA user_version").fetchone()[0] == 55  # 54→55 2026-09-07 v55: user_file_history.source gains 'framework'  # 52→53 2026-09-06 v53: strategist_decisions.infra_deaths
