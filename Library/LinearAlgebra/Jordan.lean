...
/-!
# Jordan normal form — predicate

`IsJordanForm M` characterises a square matrix in Jordan normal form.
Migrated from `Problems.LinearAlgebra.jordan_normal_form` (Asterism
Librarian, 2026-05-30): self-contained, depends only on Mathlib.
-/
